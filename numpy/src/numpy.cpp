...
PYBIND11_MODULE(numpy_bindings, m) {
    ...
    py::class_<Random>(m, "random")
        ...
        .def_static("randint", &Random::randint, py::arg("low"), py::arg("high"), py::arg("shape") = std::vector<int>{});
